          ...
          <ul className="nav flex-column">
            <li className="nav-item">
              ...
              {/*showAcademicBoard && (
                <div>
                  <div className="mt-4 mb-0 text-info">
                    <h6><i className="fas fa-caret-right fa-fw"></i>Orders</h6>
                    <hr />
                  </div>
                  <Link to={"/view-items"} className={"nav-link " +
                    (5 === this.state.currentIndex ? "active" : "")} onClick={() => this.setActiveItem(5)}>
                    <i className="fas fa-microchip fa-fw"></i> Orders
                </Link>
                </div>
              )*/}
              ...
              {showAcademicBoard && (
               ...
               {/* Add new link for tracking updates */}
               <Link to={"/track"} className={"nav-link " +
                  (15 === this.state.currentIndex ? "active" : "")} onClick={() => this.setActiveItem(158)}>
                  <i className="fas fa-truck-moving fa-fw"></i> Tracking
                </Link>
                </div>
              )}
              ...
              {showAcademicBoard && (
                ...
                <i className="fas fa-file-invoice-dollar fa-fw"></i> Billing System
                </Link>
                </div>
              )}
              ...
              {showNonacBoard && (
                ...
                <Link to={"/orders"} className={"nav-link " +
                  (5 === this.state.currentIndex ? "active" : "")} onClick={() => this.setActiveItem(122)}>
                  <i className="fas fa-microchip fa-fw"></i> Orders
                </Link>
               {/* Add new link for tracking updates */}
                <Link to={"/track"} className={"nav-link " +
                  (15 === this.state.currentIndex ? "active" : "")} onClick={() => this.setActiveItem(158)}>
                  <i className="fas fa-truck-moving fa-fw"></i> Update Tracking
                </Link>
                </div>
              )}
